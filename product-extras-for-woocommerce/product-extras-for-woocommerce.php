...
if ( ! defined( 'PEWC_PLUGIN_VERSION' ) ) {
	define( 'PEWC_PLUGIN_VERSION', '4.1.1' );
}
...
require_once dirname( __FILE__ ) . '/inc/functions-clear-all.php';
...
require_once dirname( __FILE__ ) . '/inc/functions-formulas-in-prices.php';
...
require_once dirname( __FILE__ ) . '/inc/functions-repeatable.php';
