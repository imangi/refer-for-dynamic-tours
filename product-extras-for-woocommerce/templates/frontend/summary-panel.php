...
echo '<table class="pewc-summary-panel-table">';
	...
	echo '<tbody>';
		...
		if( $summary_panel ) {
			...
			foreach( $summary_panel as $group_id => $group ) {

				echo '<tr class="pewc-summary-panel-row pewc-summary-panel-group-row pewc-summary-panel-group-' . $group_id . '"><td class="pewc-summary-line-item" colspan=2>';
