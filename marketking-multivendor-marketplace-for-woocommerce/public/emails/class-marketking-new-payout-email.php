...
if (!class_exists('Marketking_New_Payout_Email')) {
    class Marketking_New_Payout_Email extends WC_Email {

        public function __construct() {

            // set ID, this simply needs to be a unique name
            $this->id = 'marketking_new_payout_email';

            // this is the title in WooCommerce Email settings
            $this->title = esc_html__('New Payout', 'marketking-multivendor-marketplace-for-woocommerce');

            // this is the description in WooCommerce email settings
            $this->description = esc_html__('This email is sent when a payout is saved (marketking)', 'marketking-multivendor-marketplace-for-woocommerce');

            // these are the default heading and subject lines that can be overridden using the settings
            $this->heading = esc_html__('New Payout', 'marketking-multivendor-marketplace-for-woocommerce');
            $this->subject = esc_html__('New Payout', 'marketking-multivendor-marketplace-for-woocommerce');
            ...
            add_action( 'marketking_new_payout_notification', array( $this, 'trigger'), 10, 4 );
